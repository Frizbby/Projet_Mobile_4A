package com.example.projetmobile4a.data.ApiRest.Adapter
...
import com.example.projetmobile4a.data.ApiRest.Model.Pokemon
...
class PokemonListAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val itemView = LayoutInflater.from(context).inflate(R.layout.frag_api,parent,false)
